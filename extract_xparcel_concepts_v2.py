"""
Extract text from Xparcel Core Concepts Explained.docx and save to markdown
"""
...
output_path = "Xparcel_Core_Concepts_Explained.md"

with open(output_path, 'w', encoding='utf-8') as f:
    f.write("# Xparcel Core Concepts Explained\n\n")
